...
votingRoutes.route("/send/mailtocitizen").post(function (req, res) {
  ...
  var mailOptions = {
    ...
    html: 'Now you can put your vote by using your mail Id as your username and this otp ' + (Math.floor(100000 + Math.random() * 900000)
    ) + ' as password!  Thank you, Happy voting!'
  };
